      ...
      <div className="max-w-[1520px] mx-auto px-6 xl:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-white-200 p-10 flex flex-col items-center text-center space-y-10 min-h-[338px] group transition-all duration-500 hover:bg-black-800"
            >
              ...
              <div className="space-y-4">
                <h3 className="text-[20px] font-semibold text-black-900 group-hover:text-white-50 transition-colors duration-500">
                  {feature.title}
                </h3>
