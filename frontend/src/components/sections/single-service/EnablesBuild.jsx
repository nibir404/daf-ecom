      ...
      <div className="mx-auto w-full max-w-[1920px] px-[200px]">
        ...
        <div className="mx-auto max-w-[700px] flex flex-col w-full">
          {capabilities.map((item, index) => (
            <div 
              key={index} 
              className="flex items-center gap-[16px] py-[20px] border-b border-white-600 last:border-none"
            >
              <div className="shrink-0 size-[16px] text-black">
              ...
              <span className="text-[24px] font-semibold italic text-black leading-tight">
                {item}
              </span>
            </div>
          ))}
