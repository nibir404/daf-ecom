      ...
      <div className="max-w-[1520px] mx-auto flex justify-between items-center h-[80px] px-6 md:px-0">
        <div className='brand-logo flex items-center gap-10'>
          <Link to="/">
           ...
           <h3 className="nav-item"><Link to="/">Start Here</Link></h3>
        </div>
        <div className='menus '>
          <ul className='nav-links flex justify-center items-center'>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><Link to="/about">About Us</Link></li>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><Link to="/services">Services</Link></li>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><Link to="/pricing">Pricing</Link></li>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><Link to="/resources">Resources</Link></li>
          </ul>
        </div>
