      ...
      <div className='header-main flex justify-between items-center w-full bg-white/50 backdrop-blur-md px-6 md:px-20 lg:px-40 h-[80px]'>
        ...
        <div className='menus '>
          <ul className='nav-links flex justify-center items-center'>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><a href="#">About Us</a></li>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><a href="#">Services</a></li>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><a href="#">Pricing</a></li>
            <li className="nav-item hover:bg-white-50 px-5 py-4 transition duration-300 ease-in-out"><a href="#">Resources</a></li>
          </ul>
        </div>
